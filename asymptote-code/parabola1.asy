...
draw(pic1,(-2,-b)--(2,-b),p);
draw(pic1,Label("$x$",position=EndPoint, align=NE),(-2,0)--(2,0),p,Arrow(TeXHead));
draw(pic1,Label("$y$",position=EndPoint, align=NE),(0,-b)--(0,P.y+0.5),p,Arrow(TeXHead));
