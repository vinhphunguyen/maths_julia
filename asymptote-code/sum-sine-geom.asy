...
draw(pic2,arc(center,rr,-90,5),red+1.pt);

draw(pic2,O--P1--P2--P3,black+1.pt);
draw(pic2,P1--(P1.x,0),gray+.8pt);
draw(pic2,P2--(P2.x,0),gray+.8pt);
draw(pic2,P3--(P3.x,0),gray+.8pt);
draw(pic2,P3--O,red+1.pt);

real xx=P3.x+0.3;

real beta=degrees(atan(P3.y/P3.x));

draw(pic2,center--O,dashed+blue+1.pt);
draw(pic2,center--P1,dashed+blue+1.pt);
draw(pic2,center--P2,dashed+blue+1.pt);
draw(pic2,center--P3,dashed+blue+1.pt);
draw(pic2,(xx,0)--(xx,2),blue+1.pt);
draw(pic2,P1--(xx,P1.y),gray+.8pt);
draw(pic2,P2--(xx,P2.y),gray+.8pt);
draw(pic2,P3--(xx,P3.y),gray+.8pt);
...
label(pic2,"$P_1$",P1+(0.,0.18),blue);
label(pic2,"$P_2$",P2+(0.,0.19),blue);
label(pic2,"$P_3$",P3+(-.06,0.19),blue);
label(pic2,"$O$",(-0.2,0.12),blue);
label(pic2,"$d$",(1.2,1.2),red);
label(pic2,"$1$",(0.8,0.2),blue);
label(pic2,"$H$",(P3.x,-0.15),blue);
label(pic2,"$\boxed{P_3H=d\sin(\alpha+\beta)}$",(.5*P3.x,P3.y+0.95),red);
...
//xlimits(-.2,3.2);
draw(pic2,Label("$x$",Relative(0.99)),(-.2,0)--(3.2,0),black+1.pt,Arrow(TeXHead));
draw(pic2,Label("$y$",Relative(0.99)),(0,-.2)--(0,3.2),black+1.pt,Arrow(TeXHead));

// dots
dot(pic2,O,blue+5pt);
dot(pic2,P1,blue+5pt);
dot(pic2,P2,blue+5pt);
dot(pic2,P3,blue+5pt);
dot(pic2,center,red+5pt);
