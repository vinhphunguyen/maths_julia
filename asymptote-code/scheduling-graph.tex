...
\usetikzlibrary{arrows.meta,angles,quotes, arrows,calc,patterns,decorations.pathmorphing,decorations.pathreplacing,backgrounds,positioning,fit,matrix,math,shapes.geometric,shapes.misc}
...
\begin{scope}[every node/.style={circle,thick,draw}]
    \node[fill=cyan] (A) at (0,0) {Algebra};
    \node[fill=cyan] (P) at (3,0) {Physics};
    \node[fill=pink!40] (C) at (0,-3) {Chemistry};
    \node[fill=pink!40] (H) at (3,-3) {History};
\end{scope}
