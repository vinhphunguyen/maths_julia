...
draw(pic3,shift(0,0)*scale(1)*arc((0,0),1,0,91),red+1.pt);
...
draw(pic3,O--dir(alpha),black+1.pt);
draw(pic3,O--dir(2alpha),black+1.pt);
draw(pic3,O--dir(3alpha),black+1.pt);
draw(pic3,(1,0)--dir(3alpha),black+1.pt);
draw(pic3,(1,0)--(0,0),black+1.pt);
draw(pic3,P1--(1,0),black+1.pt);

label(pic3,"$C$",(0,0.05),blue);
label(pic3,"$O$",(1.04,0.02),blue);
label(pic3,"$P_1$",P1+(0.04,0.02),blue);
label(pic3,"$P_2$",P2+(0.04,0.02),blue);
...
dot(pic3,(1,0),blue+5pt);
dot(pic3,P1,blue+5pt);
dot(pic3,P2,blue+5pt);
dot(pic3,P3,blue+5pt);
