...
\tdplotsetmaincoords{60}{110}
    ...
    \begin{tikzpicture}[tdplot_main_coords,scale=2.0]
        ...
        \draw[blue,thick,opacity=0.75] plot[domain=pi:1.75*pi,smooth,variable=\t] ({cos(\t r)},{sin(\t r)},{1.0}); 
        ...
        \draw[blue,thick,opacity=0.75] plot[domain=-0.25*pi:pi,smooth,variable=\t] ({cos(\t r)},{sin(\t r)},{1.0}); 
        \node[blue,above right] at (-1,0.5,0.75) {$z = x^2 + y^2$};
    \end{tikzpicture}
